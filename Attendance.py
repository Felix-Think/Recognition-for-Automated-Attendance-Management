...
class Attendance:
    ...
    def setup_components(self):
        try:
            ...
            self.recognizer = vits8.DinoFaceRecognition(src_dir = None)
            self.FAS = FAS()
    ...
    def recognize_face(self, face_img):
        ...
        try:
            ...
            results = self.recognizer.recognize_face(rgb_img, threshold=0.75)
    ...
    def process_frame(self, frame):
        ...
        for track in tracks:
            ...
            if info['name'] != "Unknown" and info['confidence'] > 0.75:
