...
class Main_UI:
    def __init__(self, root):
        ...
        # Load images
        self.register_image = self.load_img("UI/Images/register.png", (200, 200))
        self.attendance_image = self.load_img("UI/Images/attendance.png", (200, 300))
        self.view_image = self.load_img("UI/Images/view.png", (250, 250))
