...
class Register:
    ...
    def validate_inputs(self):
        ...
        if not all(fields):
            play(AudioSegment.from_file("sounds/InputFail.mp3"))
            return False
        ...
        try:
            ...
            play(AudioSegment.from_file("sounds/DateFail.mp3"))
            return False
        ...
        if not self.cursor.fetchone():
            play(AudioSegment.from_file("sounds/DepartFail.mp3"))
            return False
    ...
    def train_new_user(self):
        ...
        try:
            ...
            play(AudioSegment.from_file("sounds/RegisterSuccess.mp3"))
        except Exception as e:
